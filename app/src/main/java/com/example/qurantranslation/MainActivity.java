...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        listView=findViewById(R.id.surahNames);
        QDH number = new QDH();
      ...
      /*  String[] surahNames = {
        ...
        try {
           //surahNames=number.GetSurahNames();

        ArrayAdapter<String> adapter=new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,number.urduSurahNames){
            @NonNull
            @Override
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                QDH number1 = new QDH();
                   int start = number1.getSurahStart(position);
                    int next_start = number1.getSurahVerses(position);
                    intent.putExtra("Start",start);
                    intent.putExtra("nextStart",next_start);
